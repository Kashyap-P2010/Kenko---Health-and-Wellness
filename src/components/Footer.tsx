        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div>
            ...
            <div className="flex space-x-4 mb-4">
              <a href="https://www.instagram.com/zeshenofficial/" className="text-emerald-100 hover:text-white transition-colors">
            ...
            <p className="text-sm text-emerald-200">
              © {new Date().getFullYear()} Kenko Health & Wellness. All rights reserved.
            </p>
          </div>
        </div>
      </div>
