  ...
  return (
    <div className="flex flex-col min-h-screen">
      ...
      <section className="py-16 md:py-24 bg-white px-4">
        <div className="container mx-auto">
          <div className="text-center max-w-3xl mx-auto mb-12">
            <h2 className="text-3xl font-bold text-emerald-800 mb-4 font-japanese">What Our Users Say</h2>
            <p className="text-gray-600">
              Discover how Kenko has transformed daily lives with simple breathing exercises.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="bg-emerald-50 rounded-lg p-6 shadow-sm">
              <div className="flex items-center mb-4">
                ...
                <div className="ml-4">
                  <h4 className="font-semibold text-emerald-800">Mei Tanaka</h4>
                  <p className="text-sm text-gray-500">Tokyo, Japan</p>
                </div>
              </div>
              <p className="text-gray-600 italic">
                "I've struggled with sleep for years. The Night Breathing Exercise has been a game-changer for me. I fall asleep faster and stay asleep longer."
              </p>
            </div>
            ...
            <div className="bg-emerald-50 rounded-lg p-6 shadow-sm">
              <div className="flex items-center mb-4">
                ...
                <div className="ml-4">
                  <h4 className="font-semibold text-emerald-800">James Wilson</h4>
                  <p className="text-sm text-gray-500">New York, USA</p>
                </div>
              </div>
              <p className="text-gray-600 italic">
                "As someone with high stress levels, the Stress Relief exercise has been essential for my daily routine. I feel calmer and more focused."
              </p>
            </div>
            ...
            <div className="bg-emerald-50 rounded-lg p-6 shadow-sm">
              <div className="flex items-center mb-4">
                ...
                <div className="ml-4">
                  <h4 className="font-semibold text-emerald-800">Sophia Chen</h4>
                  <p className="text-sm text-gray-500">Sydney, Australia</p>
                </div>
              </div>
              <p className="text-gray-600 italic">
                "The Morning Breathing technique gives me energy that lasts the whole day. It's better than coffee and takes just a few minutes!"
              </p>
            </div>
          </div>
        </div>
